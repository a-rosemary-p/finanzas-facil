...
const FAQ = [
  {
    q: '¿Cuánto cuesta?',
    a: 'Gratis hasta 10 movimientos por día — para siempre y sin anuncios. Plan Pro $79 MXN/mes con movimientos ilimitados, historial completo, rangos personalizados y reportes avanzados. Puedes cancelar cuando quieras.',
  },
  {
      ...
      >
        <div className="max-w-5xl mx-auto px-5 pt-10 pb-20 md:pt-14 md:pb-24 flex flex-col md:flex-row items-center gap-10 md:gap-14">
          ...
          <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            >
              Gratis hasta 10 movimientos, por siempre y sin anuncios · Pro $79 MXN/mes
            </p>
