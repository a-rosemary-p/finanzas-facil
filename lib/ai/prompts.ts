...
3. Descripción: máxima 60 caracteres, en español, clara y concisa. **NO duplicar el tipo en la descripción** — el campo "type" (ingreso/gasto/pendiente) ya describe la dirección. Solo el objeto/concepto. Ejemplos:
   - "vendí 50 jarrones" → description: "50 jarrones" (NO "Venta de 50 jarrones")
   - "pagué la luz" → description: "Luz" o "CFE" (NO "Pago de luz")
   - "cobré $5000 del proyecto del cliente" → description: "Proyecto cliente" (NO "Cobro del proyecto cliente")
   - "compré insumos para el taller" → description: "Insumos taller" (NO "Compra de insumos taller")
...
4. Descripción: máxima 60 caracteres, en español, clara y concisa. **NO duplicar el tipo en la descripción** — el campo "type" (ingreso/gasto/pendiente) ya describe la dirección. Solo el objeto/concepto. Ejemplos:
   - "vendí 50 jarrones" → description: "50 jarrones" (NO "Venta de 50 jarrones")
   - "pagué la luz" → description: "Luz" o "CFE" (NO "Pago de luz")
   - "cobré $5000 del proyecto del cliente" → description: "Proyecto cliente" (NO "Cobro del proyecto cliente")
   - "compré insumos para el taller" → description: "Insumos taller" (NO "Compra de insumos taller")
